...
public class RecommendBanner extends AppPanel {
    ...
    private void init() {
        ...
        // 추천 사유
        reasonLabel = new AppLabel("");
        reasonLabel.setFont(UITheme.RECOMEMND_BANNER_REASON_FONT);
        reasonLabel.setForeground(UITheme.TOUR_BANNER_SUB_FG_COLOR);

        centerTextPanel.add(titleLabel);
        centerTextPanel.add(subLabel);
        centerTextPanel.add(reasonLabel);
