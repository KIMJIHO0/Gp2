...
public class Main {
    public static void main(String[] args) {
        ...
        // 2. 테스트용 상품 데이터 시드
        memTourDAO.seed(new TourPackage(1, "제주힐링3박4일", "제주", 590000,4,
                List.of("숙소", "요트", "스노클링", "감귤")));
        memTourDAO.seed(new TourPackage(2, "부산2박3일", "부산", 390000,3,
        ...
        // 추천 DAO + Manager 생성
        RecommendationDAO recDAO = new MemRecommendDAO(tourCatalog);
        RecommendationManager recManager = new RecommendationManager(recDAO, tourCatalog);

        // 4. 추천 기능 출력
        recManager.printRecommendations();
    }
}
